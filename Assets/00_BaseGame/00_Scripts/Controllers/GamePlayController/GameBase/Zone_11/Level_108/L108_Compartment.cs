...
public class L108_Compartment : MonoBehaviour
{
    ...
    private List<L108_Item> assignedItems;

    private void Start()
    {
        assignedItems = new List<L108_Item>(new L108_Item[lsPoints.Count]);
    }
    ...
    public Vector3 AssignItemToNearestAvailable(L108_Item item, Vector3 position)
    {
