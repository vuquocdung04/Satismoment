...
public class L124_CanvasFakeBar : MonoBehaviour
{
    public BoxCollider2D boxCollider2d;
    public List<Vector2> lsPoints = new List<Vector2>();

    // Lưu trữ các item đang gắn vào từng điểm
    private List<L124_Apple> assignedItems;

    private void Start()
    {
        assignedItems = new List<L124_Apple>(new L124_Apple[lsPoints.Count]);
    }
    ...
    public Vector3 AssignItemToNearestAvailable(L124_Apple item, Vector3 position)
    {
