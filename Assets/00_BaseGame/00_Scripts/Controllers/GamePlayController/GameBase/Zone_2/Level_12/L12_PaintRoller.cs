...
public class L12_PaintRoller : MonoBehaviour
{
    public List<L143_ItemStage> stages; // Danh sách các giai đoạn lau chùi
    public int drawRadius = 10;
    public Color drawColor = Color.white;

    private int currentStageIndex; // Chỉ số của giai đoạn hiện tại
    ...
    private void DrawCircle(L143_ItemStage stage, Vector2Int center, int radius, Color color)
    {
    ...
    private L143_ItemStage currentStage;
    private Vector3 localPos;
    private float texXNormalized;
    private float texYNormalized;
    private int texX;
    private int texY;
    public void DrawAtPosition(Vector3 worldPos)
    {
        ...
        texXNormalized = (localPos.x / (currentStage.spriteRect.width / currentStage.pixelsPerUnit)) + 0.5f;
        texYNormalized = (localPos.y / (currentStage.spriteRect.height / currentStage.pixelsPerUnit)) + 0.5f;

        texX = (int)(texXNormalized * currentStage.textureWidth);
        texY = (int)(texYNormalized * currentStage.textureHeight);
