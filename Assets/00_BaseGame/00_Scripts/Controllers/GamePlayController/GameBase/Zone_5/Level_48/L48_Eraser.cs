...
public class L48_Eraser : MonoBehaviour
{
    ...
    void InitCurrentStage()
    {
        ...
        {
            currentStage.targetSpriteRenderer.maskInteraction = SpriteMaskInteraction.VisibleOutsideMask;
    ...
    int dy;
    int index;
    void DrawCircle(L143_ItemStage stage, Vector2Int center, int radius, Color color)
    {
